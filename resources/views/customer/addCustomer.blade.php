                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="inputBilling" name="billing" class="form-control @error('billing') is-invalid @enderror" placeholder="Masukkan Billing" value="{{ old('billing') }}" required="required" autocomplete="billing">
                            @error('billing')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="inputCreateDate" name="create_date" class="form-control @error('create_date') is-invalid @enderror" required="required" autocomplete="create_date">
                            @error('create_date')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
